...
/**
 * In-memory credentials provider for this suite. Only the record half is
 * exercised — the flow under test never touches a plain credential
 * reference — so the reference half answers "nothing stored".
 */
